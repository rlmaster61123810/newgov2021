...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('forms.index') }}">แบบตอบรับโครงการ</a></li>
            <li class="breadcrumb-item active" aria-current="page">แก้ไขแบบตอบรับโครงการ</li>
        </ol>
    </nav>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">แก้ไขแบบตอบรับโครงการ</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('forms.update', $form->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="auditor_name" id="auditor_name"
                                placeholder="ชื่อผู้ตรวจสอบ" value="{{ $form->auditor_name }}">
                            {{-- has error --}}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="auditor_position" id="auditor_position"
                                placeholder="ตำแหน่งผู้ตรวจสอบ" value="{{ $form->auditor_position }}">
                            {{-- has error --}}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="auditor_phone" id="auditor_phone"
                                placeholder="เบอร์โทรผู้ตรวจสอบ" value="{{ $form->auditor_phone }}">
                            {{-- has error --}}
