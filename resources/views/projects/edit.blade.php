                    ...
                    <form action="{{ route('projects.update', $project->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="register_details" name="register_details"
                                rows="3">{{ $project->register_details }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="start_date" name="start_date"
                                value="{{ date('Y-m-d\TH:i', strtotime($project->start_date)) }}">
                            @error('start_date')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="end_date" name="end_date"
                                value="{{ date('Y-m-d\TH:i', strtotime($project->end_date)) }}">
                            @error('end_date')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="comment" name="comment"
                                rows="3">{{ $project->comment }}</textarea>
                            @error('comment')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary">แก้ไขข้อมูลโครงการ</button>
                    </form>
                </div>
            </div>
        </div>
